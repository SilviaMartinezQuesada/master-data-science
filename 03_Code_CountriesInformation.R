...
path_to_save <- "C:/Users/SilviaMartinezQuesad/OneDrive - TOKIOTA/Máster Kschool 2018-2019/TFM/Entregable"
...
write.csv(myDF2, file = paste(path_to_save, "df_countries.csv", sep="/"), row.names = FALSE, na = "")
